...
- Planned Research: Cross-cultural decision-making & the effect of language
...
- Predicted Grade: 1st Class Honours
- Core Specialisations: Behavioural Neuroscience, Social & Cognitive Psychology, Probability & Statistics, Experimental Design
...
- Performed data cleaning, statistical modelling, and visualisation in R using mixed-effects regression.

**Junior Researcher Programme (JRP) & University of Primorska** — Lead Writing & Literature Analyst *(Jul. 2024 – Present)*
PI: Dr. Nina Krohne
- Co-leading a cross-cultural randomised controlled study evaluating the *iAlive* digital intervention for suicide prevention.
...
- Developed R scripts for complex visualisations of primary and secondary outcomes in a 26-country study on climate change messaging.
- Facilitated inclusion of the Chinese cohort by translating study materials and securing 1,908 valid responses within one week.

**Forensic Psychiatry Research Group, University of Oxford** — Research Assistant *(Jan. 2024 – Jul. 2025)*
PI: Prof. Seena Fazel
- Screened over 5,950 titles/abstracts and performed data extraction across two systematic review and meta-analysis projects on suicide risk prediction.
...
**Cowry Consulting** — Behavioural Architect *(Aug. 2025)*
- Redesigned website architecture for Hypha Studios using the COM-B behavioural model; led the A/B testing framework as Experimental Designer.

**Oxford Behavioural Insights Group (OxBIG)** — Co-Founder & Public Engagement Officer *(Nov. 2023 – Jul. 2025)*
- Co-founded the society to advance behavioural science at Oxford; grew engagement through social media content and inter-society partnerships.

**LEVRA** — Research Analyst *(Dec. 2023 – Jun. 2024)*
- Applied the Octalysis gamification framework to redesign portal pages; proposed AI model integrations to optimise learning transfer.

**Oxford University Chinese Society (OUCS)** — Secretary *(Oct. 2022 – Apr. 2024)*
- Directed the 2023 Oxford Orientation Camp (130+ participants); secured Coca-Cola sponsorship reducing expenditure by ¥10,000.

---

## Technical Skills

- **Programming & Analysis:** R, Python, MATLAB; mixed-effects modelling, MVPA
- **Neuroscience Methods:** EEG signal processing, neuroanatomy, multivariate pattern analysis
- **Experimental Design:** Qualtrics (complex survey logic), naturalistic behavioural paradigms
- **Research Management:** Cross-cultural recruitment (China/UK), ethics-compliant participant management, open science (OSF)
